  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        fresh: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-card hover:shadow-floating",
        spice: "bg-gradient-secondary text-secondary-foreground hover:scale-105 shadow-card hover:shadow-floating",
        mobile: "h-14 text-lg font-semibold rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 shadow-card hover:shadow-floating",
      },
      size: {
